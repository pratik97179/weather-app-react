...
const Weather = () => {
  ...
  const [searchkey, setsearchKey] = useState("USA");
  const resultTime =
    forecast["location"] && forecast["location"]["localtime"].split(" ");
    ...
    realTime=resultTime?resultTime[1]:time;
    ...
    <div className="body-card">
      ...
      <div className="weather-card">
        <WeatherCard
          type={"Temperature"}
          action={
            forecast["current"] != null && `${forecast["current"]["temp_c"]}°C`
          }
        />
        <WeatherCard
          type={"Wind Speed"}
      ...
      <WeatherStats
        uvIndex={forecast["current"] != null ? forecast["current"]["uv"] : ""}
        visibility={
          forecast["current"] != null ? forecast["current"]["vis_km"] : ""
        }
        feelsLike={
          forecast["current"] != null ? forecast["current"]["feelslike_c"] : ""
        }
        precip={
          forecast["current"] != null ? forecast["current"]["precip_mm"] : ""
        }
      />
    </div>
  );
